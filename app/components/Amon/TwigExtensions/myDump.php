...
final class myDump extends AbstractExtension
{
	
    public function getFunctions()
    {
        $function = new TwigFunction('mydump', [$this, 'myDump'], [
  ...
  public static function myDump($var): string {
	$dump = new _MyDump();
	$type = ucfirst(gettype($var));	
	if (($type === 'Array') or ($type === 'Object'))
	{
		return $dump->mydump($var, 'dark');
	}else{
		return '';
	}
  }
